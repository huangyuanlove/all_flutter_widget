...
class ChangeColorWidget extends StatefulWidget {
  ChangeColorWidget({Key key, this.title}) : super(key: key);
...
class _ChangeColorWidgetState extends State<ChangeColorWidget>
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body: FlareActor("assets/image/ChangeColorExample.flr",
          // You can find the example project here: https://www.2dimensions.com/a/castor/files/flare/change-color-example
          fit: BoxFit.contain,
