...
import 'package:flutter_widget/widget_test/flare/slider/house_controller.dart';

class SliderPage extends StatefulWidget {
  final String title;

  SliderPage({this.title, Key key}) : super(key: key);
        ...
        body: Container(
            child: Listener(
              ...
              child: Stack(fit: StackFit.expand, children: [
                FlareActor("assets/image/slider/Resizing_House.flr",
